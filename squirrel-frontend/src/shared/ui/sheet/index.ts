...
export const sheetVariants = cva(
  'fixed z-50 gap-4 border-border/80 bg-card p-5 shadow-[var(--shadow-popup)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
