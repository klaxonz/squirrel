...
<template>
  <SelectPortal>
    <SelectContent
      ...
      :class="cn(
        'relative z-[110] max-h-80 min-w-[12rem] bg-background border border-border/20 rounded-xl shadow-[0_12px_40px_-12px_rgba(0,0,0,0.5)] outline-none overflow-hidden',
