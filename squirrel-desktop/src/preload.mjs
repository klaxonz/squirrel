...
contextBridge.exposeInMainWorld('desktopApp', Object.freeze({
  ...
  resolveBilibiliSubtitles: (targetUrl, options) => ipcRenderer.invoke('desktop:resolve-bilibili-subtitles', targetUrl, options),
  resolveJavdbPlayback: (targetUrl, options) => ipcRenderer.invoke('desktop:resolve-javdb-playback', targetUrl, options),
  resolveJavdbMetadata: (targetUrl) => ipcRenderer.invoke('desktop:resolve-javdb-metadata', targetUrl),
  ...
  getYouPornProfileAvatar: (profileUrl) => ipcRenderer.invoke('desktop:get-youporn-profile-avatar', profileUrl),
