...
$PluginsDir = Join-Path $ProjectRoot "squirrel-plugins"
$DistDir = Join-Path $ProjectRoot "plugin_packages"
$PluginsExtDir = Join-Path $ProjectRoot "squirrel-backend\plugins_ext"
