...
- Move subscription retry reconciliation and video extraction projection refresh out of `CrawlTaskService` into explicit worker/runtime or domain completion hooks.
