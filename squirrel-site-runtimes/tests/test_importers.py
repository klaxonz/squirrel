...
PORNHUB_IMPORTER_PATH = (
    REPO_ROOT / 'squirrel-site-runtimes' / 'pornhub' / 'src' / 'squirrel_pornhub' / 'importer.py'
)
JAVDB_IMPORTER_PATH = (
    REPO_ROOT / 'squirrel-site-runtimes' / 'javdb' / 'src' / 'squirrel_javdb' / 'importer.py'
)
YOUTUBE_IMPORTER_PATH = (
    REPO_ROOT / 'squirrel-site-runtimes' / 'youtube' / 'src' / 'squirrel_youtube' / 'importer.py'
)
