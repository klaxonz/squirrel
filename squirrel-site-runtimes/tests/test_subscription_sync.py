...
PORNHUB_SUBSCRIPTION_PATH = (
    REPO_ROOT / 'squirrel-site-runtimes' / 'pornhub' / 'src' / 'squirrel_pornhub' / 'subscription.py'
)
JAVDB_SUBSCRIPTION_PATH = (
    REPO_ROOT / 'squirrel-site-runtimes' / 'javdb' / 'src' / 'squirrel_javdb' / 'subscription.py'
)
YOUTUBE_SUBSCRIPTION_PATH = (
    REPO_ROOT / 'squirrel-site-runtimes' / 'youtube' / 'src' / 'squirrel_youtube' / 'subscription.py'
)
