...
def filter_cookies_to_query_string(target_url):
    ...
    cj.load(file_path, ignore_discard=False, ignore_expires=False)
...
def json_cookie_to_netscape(cookies: dict, domain_list: list, output_file):
    with open(output_file, 'w') as f:
        ...
        f.write("# This file was generated by a Python script! Edit at your own risk.\n")
        f.write("\n")
        ...
        for site in cookies:
            ...
            for cookie in site_cookie:
                ...
                if 'expirationDate' not in cookie or cookie['expirationDate'] == '':
                    continue
