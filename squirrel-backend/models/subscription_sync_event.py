...
from sqlalchemy import JSON, VARCHAR, DateTime, Index, Integer, Text, UniqueConstraint
...
class SubscriptionSyncEvent(Base, SerializerMixin):
    ...
    event_phase: Mapped[str | None] = mapped_column(VARCHAR(32), nullable=True)
    event_status: Mapped[str | None] = mapped_column(VARCHAR(16), nullable=True)
