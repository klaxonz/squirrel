...
from sqlalchemy import VARCHAR, DateTime, Index, Integer
...
class SubscriptionSyncSubscriptionProjection(Base, SerializerMixin):
    ...
    latest_run_id: Mapped[str | None] = mapped_column(VARCHAR(64), nullable=True)
    ...
    last_error_message: Mapped[str | None] = mapped_column(VARCHAR(1024), nullable=True)
