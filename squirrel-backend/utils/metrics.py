...
class MetricsCollector:
    ...
    def get_counter(self, name: str, tags: Optional[Dict[str, str]] = None, window: str = "1m") -> int:
        """
        查询计数器值
    ...
    def collect_snapshots(self, metric_names: Optional[List[str]] = None) -> List[MetricSnapshot]:
        """
        收集指标快照（用于持久化到数据库）
