...
from services import subscription_sync_state_service, video_service
...
_default = VideoExtractionCoordinator()
enqueue_discovered_videos = _default.enqueue_discovered_videos
