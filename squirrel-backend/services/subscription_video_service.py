...
def get_subscription_video_by_video_id(video_id: int) -> SubscriptionVideo | None:
...
def get_subscription_video(subscription_id: int, video_id: int) -> SubscriptionVideo | None:
    with get_session() as session:
