...
class RssService:
    ...
    def create_account(self, user_id, *, provider, name, base_url, username, credential, enabled=True, sync_entry_limit=None):
        return create_account(user_id, provider=provider, name=name, base_url=base_url, username=username, credential=credential, enabled=enabled, sync_entry_limit=sync_entry_limit)
    ...
    def list_entries(self, user_id, *, account_id=None, feed_id=None, is_read=None, is_starred=None, page=1, page_size=30):
        return list_entries(user_id, account_id=account_id, feed_id=feed_id, is_read=is_read, is_starred=is_starred, page=page, page_size=page_size)
    ...
    def update_account(self, user_id, account_id, *, provider=None, name=None, base_url=None, username=None, credential=None, enabled=None, sync_entry_limit=None):
        return update_account(user_id, account_id, provider=provider, name=name, base_url=base_url, username=username, credential=credential, enabled=enabled, sync_entry_limit=sync_entry_limit)
