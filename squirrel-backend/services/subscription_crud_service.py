...
_default = SubscriptionCrudService()
get_subscription_by_id = _default.get_subscription_by_id
get_subscription_by_url_and_name = _default.get_subscription_by_url_and_name
get_active_user_subscription_by_url = _default.get_active_user_subscription_by_url
get_active_user_subscription_url_map = _default.get_active_user_subscription_url_map
get_deleted_user_subscription_urls = _default.get_deleted_user_subscription_urls
check_subscription_status = _default.check_subscription_status
get_user_subscription_nsfw = _default.get_user_subscription_nsfw
get_user_subscription_special_followed = _default.get_user_subscription_special_followed
verify_subscription_access = _default.verify_subscription_access
update_subscription = _default.update_subscription
toggle_status = _default.toggle_status
