...
from services.subscription_sync_state_service import _default as _default_sync_state_service
...
class SubscriptionManageService:
    def __init__(self, session_factory=get_session, crud_service=None, sync_state_service=None):
        ...
        self.sync_state_service = sync_state_service or _default_sync_state_service
...
_default = SubscriptionManageService()
create_subscription = _default.create_subscription
restore_subscription = _default.restore_subscription
unsubscribe_by_id = _default.unsubscribe_by_id
toggle_nsfw_status = _default.toggle_nsfw_status
toggle_special_follow_status = _default.toggle_special_follow_status
create_subscribe_message = _default.create_subscribe_message
list_user_ids = _default.list_user_ids
