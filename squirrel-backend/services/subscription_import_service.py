...
from services.subscription_crud_service import _default as _default_crud_service
from services.subscription_manage_service import _default as _default_manage_service
...
class SubscriptionImportService:
    def __init__(self, session_factory=get_session, crud_service=None, manage_service=None):
        ...
        self.crud_service = crud_service or _default_crud_service
        self.manage_service = manage_service or _default_manage_service
...
_default = SubscriptionImportService()
get_runtime_supported_sites = _default.get_runtime_supported_sites
get_enabled_runtime_import_sites = _default.get_enabled_runtime_import_sites
handle_subscribe_request = _default.handle_subscribe_request
preview_user_subscriptions = _default.preview_user_subscriptions
import_user_subscriptions = _default.import_user_subscriptions
auto_import_missing_subscriptions = _default.auto_import_missing_subscriptions
