...
_default = VideoCrudService()
get_video_by_url = _default.get_video_by_url
get_videos_by_urls = _default.get_videos_by_urls
get_video_by_id = _default.get_video_by_id
create_video = _default.create_video
save_remote_video = _default.save_remote_video
