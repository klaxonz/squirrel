...
from services.crawl.tasks.task_types import resolve_subscription_sync_task_type
from services.subscription.update.command_events import (
    SubscriptionSyncCommandEventPublisher,
    subscription_sync_command_event_publisher,
)
from services.subscription.update.command_payloads import build_command, build_task_payload, resolve_priority
from services.subscription.update.command_preflight import resolve_preflight_result
from services.subscription.update.queueing import SubscriptionSyncQueuePlanner
...
class SubscriptionSyncCommandService:
    ...
    def run_inline_sync(
        ...
        *,
        ...
        from services.crawl.executors.subscription_sync_executor import execute_subscription_sync_payload
