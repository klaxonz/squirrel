...
_default = UserVideoFeedService()
backfill_user_subscription_feed = _default.backfill_user_subscription_feed
remove_user_subscription_feed = _default.remove_user_subscription_feed
remove_subscription_feed = _default.remove_subscription_feed
update_user_subscription_nsfw = _default.update_user_subscription_nsfw
add_video_to_active_subscribers = _default.add_video_to_active_subscribers
refresh_video_feed_metadata = _default.refresh_video_feed_metadata
