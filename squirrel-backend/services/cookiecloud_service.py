...
_default = CookieCloudService()
is_cookiecloud_configured = _default.is_cookiecloud_configured
fetch_cookiecloud_cookie_data = _default.fetch_cookiecloud_cookie_data
sync_cookiecloud_to_site_files = _default.sync_cookiecloud_to_site_files
