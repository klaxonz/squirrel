...
_default = OutboxEventService()
publish_event = _default.publish_event
consume_available_events = _default.consume_available_events
create_listener_stop_event = _default.create_listener_stop_event
run_notification_listener = _default.run_notification_listener
