...
from services.video.search.query import build_base_video_query as _default_build_base_video_query
from services.video.search.query import category_predicate as _default_category_predicate
