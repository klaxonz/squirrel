...
from services.video.listing.query_filters import (
...
from services.video.search.query import duration_predicate as _default_duration_predicate
...
class VideoListQueryService:
    def __init__(
        ...
        if parse_search_query is None:
            from services.search.query import parse_search_query as _psq
            self._parse_search_query = _psq
        else:
            self._parse_search_query = parse_search_query

        if normalize_subscription_type_term is None:
            from services.search.query import normalize_subscription_type_term as _nstt
