...
from infrastructure.cache.redis_client import redis_client as _global_redis_client
from infrastructure.config.settings import settings as _global_settings
