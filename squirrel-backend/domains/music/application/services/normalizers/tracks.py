...
def normalize_track(row: dict[str, Any]) -> dict[str, Any]:
    ...
    payload = {
        ...
        'cover': format_image_url(
            ...
            or row.get('img')
            or row.get('imgurl')
            or row.get('sizable_cover')
            or album_info.get('sizable_cover')
            or album_info.get('cover')
            or album_info.get('imgurl')
            or albuminfo.get('sizable_cover')
            or albuminfo.get('cover')
            or albuminfo.get('imgurl')
