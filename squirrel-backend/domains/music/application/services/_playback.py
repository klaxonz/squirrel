...
from domains.music.application.services.normalizers.lyrics import parse_lrc
from domains.music.application.services.normalizers.media import normalize_mv
