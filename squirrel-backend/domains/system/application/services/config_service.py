...
def to_bool(val: str | None, default: bool | None = None) -> bool | None:
    """Coerce a config string to bool.

    Returns ``default`` (``None`` if unset) for null input or unknown tokens,
    matching the old module-level ``to_bool`` and ``SystemConfigService._to_bool``
    signatures.
    """
    if val is None:
        return default
...
class SystemConfigService:
    ...
    def get_bool(self, key: str, default: bool) -> bool:
        ...
        bool_val = to_bool(db_value, default)
