...
def config_from_account(account: RssAccount) -> Any:
    from domains.rss.application.services.client._base import RssAccountConfig
...
def test_account_config(
    *,
    ...
    from domains.rss.application.services.client._base import RssAccountConfig, RssServiceError
    from domains.rss.application.services.client._factory import create_client, normalize_base_url, normalize_provider
