...
def upgrade():
    ...
    op.create_index(
        'ix_subscription_sync_state_subscription_id', 'subscription_sync_state', ['subscription_id'], unique=False
    )
    op.create_index('ix_subscription_sync_state_sync_status', 'subscription_sync_state', ['sync_status'], unique=False)
    op.create_index(
        'ix_subscription_sync_state_next_sync_at', 'subscription_sync_state', ['next_sync_at'], unique=False
    )
    op.create_index(
