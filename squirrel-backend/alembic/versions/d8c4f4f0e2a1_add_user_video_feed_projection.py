...
def upgrade():
    ...
    op.create_index(
        'ix_user_video_feed_user_publish_video',
        'user_video_feed',
        ['user_id', 'publish_date', 'video_id'],
        unique=False,
    )
    op.create_index(
        'ix_user_video_feed_user_created_video',
        'user_video_feed',
        ['user_id', 'video_created_at', 'video_id'],
        unique=False,
    )
    op.create_index(
        'ix_user_video_feed_user_sub_publish',
        'user_video_feed',
        ['user_id', 'subscription_id', 'publish_date'],
        unique=False,
    )
    op.create_index(
        'ix_user_video_feed_user_nsfw_publish', 'user_video_feed', ['user_id', 'is_nsfw', 'publish_date'], unique=False
    )
