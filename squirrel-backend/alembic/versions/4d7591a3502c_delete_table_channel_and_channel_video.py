...
def downgrade():
    ...
    op.add_column('download_task',
                  sa.Column('channel_name', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=255), nullable=True))
    op.add_column('download_task',
    ...
    op.add_column('download_task',
                  sa.Column('channel_id', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=255), nullable=True))
    op.add_column('download_task',
                  sa.Column('channel_avatar', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=2048),
                            nullable=True))
    op.add_column('download_task',
                  sa.Column('channel_url', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=2048), nullable=True))
    op.create_table('channel_video',
                    sa.Column('id', mysql.INTEGER(), autoincrement=True, nullable=False),
                    sa.Column('channel_id', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=255), nullable=False),
                    sa.Column('channel_name', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=255),
                              nullable=False),
                    sa.Column('channel_avatar', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=2048),
                              nullable=False),
