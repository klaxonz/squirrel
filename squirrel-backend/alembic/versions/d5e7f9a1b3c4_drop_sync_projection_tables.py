...
def downgrade():
    ...
    op.create_index("ix_subscription_sync_run_projection_subscription", "subscription_sync_run_projection", ["subscription_id"], unique=False)
    op.create_index("ix_subscription_sync_run_projection_status_time", "subscription_sync_run_projection", ["status", "last_event_at"], unique=False)
    op.create_index("ix_subscription_sync_run_projection_site_time", "subscription_sync_run_projection", ["site", "last_event_at"], unique=False)
    op.create_index("ix_subscription_sync_run_projection_started_at", "subscription_sync_run_projection", ["started_at"], unique=False)
    op.create_index("ix_subscription_sync_run_projection_finished_at", "subscription_sync_run_projection", ["finished_at"], unique=False)
    op.create_index("ix_subscription_sync_run_projection_subscription_time", "subscription_sync_run_projection", ["subscription_id", "last_event_at"], unique=False)
    op.create_index("ix_subscription_sync_run_projection_subscription_started", "subscription_sync_run_projection", ["subscription_id", "started_at"], unique=False)
    ...
    op.create_index("ix_subscription_sync_subscription_projection_status", "subscription_sync_subscription_projection", ["current_status"], unique=False)
    op.create_index("ix_subscription_sync_subscription_projection_next_sync", "subscription_sync_subscription_projection", ["next_sync_at"], unique=False)
    op.create_index("ix_subscription_sync_subscription_projection_updated_at", "subscription_sync_subscription_projection", ["updated_at"], unique=False)
    op.create_index("ix_subscription_sync_subscription_projection_status_next_sync", "subscription_sync_subscription_projection", ["current_status", "next_sync_at"], unique=False)
    ...
    op.create_index("ix_subscription_sync_trend_bucket_time", "subscription_sync_trend_projection", ["bucket_time"], unique=False)
    op.create_index("ix_subscription_sync_trend_site_bucket", "subscription_sync_trend_projection", ["site", "bucket_time"], unique=False)
    op.create_index("ix_subscription_sync_trend_dims_bucket", "subscription_sync_trend_projection", ["site", "sync_mode", "trigger", "bucket_time"], unique=False)
