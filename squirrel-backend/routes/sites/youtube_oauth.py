...
def setup_youtube_oauth():
    try:
        from services.site_catalog.youtube_oauth import setup_oauth_via_daemon
...
def get_youtube_oauth_status():
    try:
        from services.site_catalog.youtube_oauth import poll_oauth_status_via_daemon
...
def revoke_youtube_oauth():
    try:
        from services.site_catalog.youtube_oauth import revoke_oauth_via_daemon
