...
from .client import SiteRuntimeInvocationClient
from .models import (
    SiteRuntimeHandle,
    SiteRuntimeRecord,
    SiteRuntimeState,
...
class SiteRuntimeLifecycleError(RuntimeError):
    """Raised when runtime lifecycle fails."""
...
class SiteRuntimeLifecycle:
    ...
    subprocesses, log streams, expiry timers).
    """
    def __init__(
        self,
        *,
    ...
    def _wait_for_runtime(
        ...
        try:
            ...
            raise SiteRuntimeLifecycleError(str(exc)) from exc
